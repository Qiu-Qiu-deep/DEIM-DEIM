...
### dfine-s-hyper-lite.yaml

**特点**: 在每个尺度特征后独立添加超图
```yaml
- [-1, RepNCSPELAN4, [...]] # P3
- [-1, HyperGraphEnhanceLite, [6]]  # threshold=6
- [-1, RepNCSPELAN4, [...]] # P4
- [-1, HyperGraphEnhanceLite, [8]]  # threshold=8
- [-1, RepNCSPELAN4, [...]] # P5
- [-1, HyperGraphEnhanceLite, [10]] # threshold=10
```
