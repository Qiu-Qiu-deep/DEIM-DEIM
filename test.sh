...
CUDA_VISIBLE_DEVICES=4 python train.py -c configs/yaml/dfine.yml -r outputs/dfine_72e2/best_stg2.pth --test-only --eval-wda # -u val_dataloader.total_batch_size=1 
