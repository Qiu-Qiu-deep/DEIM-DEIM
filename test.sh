...
torchrun --master_port=9928 --nproc_per_node=$NUM_GPUS train.py -c configs/baseline/rtdetrv2_r18vd_120e_coco.yml -r outputs/rtdetrv2_r18vd_120e_custom/best_stg2.pth --test-only