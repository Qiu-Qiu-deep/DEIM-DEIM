...
class AFNO2D(nn.Module):
    def __init__(self, dim, expansion_ratio=2,
        ...
        self.pwconv1 = nn.Linear(dim, self.med_channels, bias=bias) # y=a@x+b
        self.act1 = act1_layer()
    ...
    def forward(self, x):
        ...
        x = torch.stack([o2_real, o2_imag], dim=-1)  # stack like concat
...
@register_model
def dfformer_s36(pretrained=True, **kwargs):
...
@register_model
def dfformer_m36(pretrained=True, **kwargs):
...
@register_model
def dfformer_b36(pretrained=True, **kwargs):
...
@register_model
def gfformer_m36(pretrained=False, **kwargs):
    default_cfg = default_cfgs['gfformer_m36']
    model = MetaFormer(
        depths=[3, 12, 18, 3],
        dims=[96, 192, 384, 576],
        token_mixers=GlobalFilter,
...
@register_model
def cdfformer_s18(pretrained=True, **kwargs):
...
@register_model
def cdfformer_s36(pretrained=True, **kwargs):
...
@register_model
def cdfformer_m36(pretrained=True, **kwargs):
...
@register_model
def cdfformer_b36(pretrained=True, **kwargs):
...
@register_model
def dfformer_m36_afno(pretrained=False, **kwargs):
    default_cfg = default_cfgs['cdfformer_m36']
    model = MetaFormer(
        depths=[3, 12, 18, 3],
        dims=[96, 192, 384, 576],
