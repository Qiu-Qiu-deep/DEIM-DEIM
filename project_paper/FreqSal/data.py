...
def cv_random_flip(img, label, depth, edge):
    ...
    if flip_flag == 1:
        ...
        edge = edge.transpose(Image.FLIP_LEFT_RIGHT) # J
...
def get_loader(image_root, gt_root, depth_root, edge_root, batchsize, trainsize, shuffle=False, num_workers=0, pin_memory=True):  # shuffle=True
